...
public class CSSFontFeatureSettings {
    ...
    private static CSSFontFeatureSettings parseVariantLigaturesSpecial(List<String> tokens) {
        ...
        switch (containsWhich(tokens, FONT_VARIANT_DISCRETIONARY_LIGATURES, FONT_VARIANT_NO_DISCRETIONARY_LIGATURES)) {
            case 1:
                result.settings.put(FEATURE_DLIG, VALUE_ON);
                found = true;
                break;
            case 2:
                result.settings.put(FEATURE_DLIG, VALUE_OFF);
                found = true;
                break;
            case 3:
                return ERROR;
        ...
        switch (containsWhich(tokens, FONT_VARIANT_HISTORICAL_LIGATURES, FONT_VARIANT_NO_HISTORICAL_LIGATURES)) {
            case 1:
                result.settings.put(FEATURE_HLIG, VALUE_ON);
                found = true;
                break;
            case 2:
                result.settings.put(FEATURE_HLIG, VALUE_OFF);
                found = true;
                break;
            case 3:
                return ERROR;
        ...
        switch (containsWhich(tokens, FONT_VARIANT_CONTEXTUAL_LIGATURES, FONT_VARIANT_NO_CONTEXTUAL_LIGATURES)) {
            case 1:
                result.settings.put(FEATURE_CALT, VALUE_ON);
                found = true;
                break;
            case 2:
                result.settings.put(FEATURE_CALT, VALUE_OFF);
                found = true;
                break;
            case 3:
                return ERROR;
    ...
    static CSSFontFeatureSettings parseVariantPosition(String val) {
        ...
        switch (val) {
            case FONT_VARIANT_SUB:
                result.settings.put(FEATURE_SUBS, VALUE_ON);
                break;
            case FONT_VARIANT_SUPER:
                result.settings.put(FEATURE_SUPS, VALUE_ON);
                break;
            default:
                return null;
        }
    ...
    private static boolean setCapsFeature(CSSFontFeatureSettings result, String val) {
        switch (val) {
            case FONT_VARIANT_SMALL_CAPS:
                result.settings.put(FEATURE_SMCP, VALUE_ON);
                break;
            case FONT_VARIANT_ALL_SMALL_CAPS:
                result.addSettings(FEATURE_SMCP, FEATURE_C2SC, VALUE_ON);
                break;
            case FONT_VARIANT_PETITE_CAPS:
                result.settings.put(FEATURE_PCAP, VALUE_ON);
                break;
            case FONT_VARIANT_ALL_PETITE_CAPS:
                result.addSettings(FEATURE_PCAP, FEATURE_C2PC, VALUE_ON);
                break;
            case FONT_VARIANT_UNICASE:
                result.settings.put(FEATURE_UNIC, VALUE_ON);
                break;
            case FONT_VARIANT_TITLING_CAPS:
                result.settings.put(FEATURE_TITL, VALUE_ON);
                break;
            default:
                return false;
        }
    ...
    private static CSSFontFeatureSettings parseVariantNumericSpecial(List<String> tokens) {
        ...
        switch (containsWhich(tokens, FONT_VARIANT_LINING_NUMS, FONT_VARIANT_OLDSTYLE_NUMS)) {
            case 1:
                result.settings.put(FEATURE_LNUM, VALUE_ON);
                found = true;
                break;
            case 2:
                result.settings.put(FEATURE_ONUM, VALUE_ON);
                found = true;
                break;
            case 3:
                return ERROR;
        ...
        switch (containsWhich(tokens, FONT_VARIANT_PROPORTIONAL_NUMS, FONT_VARIANT_TABULAR_NUMS)) {
            case 1:
                result.settings.put(FEATURE_PNUM, VALUE_ON);
                found = true;
                break;
            case 2:
                result.settings.put(FEATURE_TNUM, VALUE_ON);
                found = true;
                break;
            case 3:
                return ERROR;
        ...
        switch (containsWhich(tokens, FONT_VARIANT_DIAGONAL_FRACTIONS, FONT_VARIANT_STACKED_FRACTIONS)) {
            case 1:
                result.settings.put(FEATURE_FRAC, VALUE_ON);
                found = true;
                break;
            case 2:
                result.settings.put(FEATURE_AFRC, VALUE_ON);
                found = true;
                break;
            case 3:
                return ERROR;
        ...
        switch (containsOnce(tokens, FONT_VARIANT_ORDINAL)) {
            case 1:
                result.settings.put(FEATURE_ORDN, VALUE_ON);
                found = true;
                break;
            case 2:
                return ERROR;
        ...
        switch (containsOnce(tokens, FONT_VARIANT_SLASHED_ZERO)) {
            case 1:
                result.settings.put(FEATURE_ZERO, VALUE_ON);
                found = true;
                break;
            case 2:
                return ERROR;
    ...
    private static CSSFontFeatureSettings parseVariantEastAsianSpecial(List<String> tokens) {
        ...
        if (which != null) {
            switch (which) {
                case FONT_VARIANT_JIS78:
                    result.settings.put(FEATURE_JP78, VALUE_ON);
                    break;
                case FONT_VARIANT_JIS83:
                    result.settings.put(FEATURE_JP83, VALUE_ON);
                    break;
                case FONT_VARIANT_JIS90:
                    result.settings.put(FEATURE_JP90, VALUE_ON);
                    break;
                case FONT_VARIANT_JIS04:
                    result.settings.put(FEATURE_JP04, VALUE_ON);
                    break;
                case FONT_VARIANT_SIMPLIFIED:
                    result.settings.put(FEATURE_SMPL, VALUE_ON);
                    break;
                case FONT_VARIANT_TRADITIONAL:
                    result.settings.put(FEATURE_TRAD, VALUE_ON);
                    break;
                case TOKEN_ERROR:
                    return ERROR;  // more than one, or duplicate, found
            }
            found = true;
        }
        ...
        switch (containsWhich(tokens, FONT_VARIANT_FULL_WIDTH, FONT_VARIANT_PROPORTIONAL_WIDTH)) {
            case 1:
                result.settings.put(FEATURE_FWID, VALUE_ON);
                found = true;
                break;
            case 2:
                result.settings.put(FEATURE_PWID, VALUE_ON);
                found = true;
                break;
            case 3:
                return ERROR;
        ...
        switch (containsOnce(tokens, FONT_VARIANT_RUBY)) {
            case 1:
                result.settings.put(FEATURE_RUBY, VALUE_ON);
                found = true;
                break;
            case 2:
                return ERROR;
    ...
    public void applySettings(CSSFontFeatureSettings featureSettings) {
        if (featureSettings == null)
            return;
        settings.putAll(featureSettings.settings);
    }

    public void applyKerning(Style.FontKerning kern) {
        if (kern == Style.FontKerning.none)
            settings.put(FEATURE_KERN, VALUE_OFF);
        else
            settings.put(FEATURE_KERN, VALUE_ON);
    }
    ...
    private void addSettings(String feature1, String feature2, int onOrOff) {
        settings.put(feature1, onOrOff);
        settings.put(feature2, onOrOff);
    }
