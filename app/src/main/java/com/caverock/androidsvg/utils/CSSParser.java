...
public class CSSParser {
    ...
    private final MediaType deviceMediaType;
    private final Source source;    // Where these rules came from (Parser or RenderOptions)
    ...
    CSSParser(MediaType rendererMediaType, Source source, SVGExternalFileResolver externalFileResolver) {
        deviceMediaType = rendererMediaType;
        this.source = source;
   ...
   */
    ...
    static class Selector {
        ...
        int size() {
            return (simpleSelectors == null) ? 0 : simpleSelectors.size();
        }

        SimpleSelector get(int i) {
            return simpleSelectors.get(i);
        }
