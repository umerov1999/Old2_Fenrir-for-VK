...
import com.caverock.androidsvg.utils.CSSParser.Ruleset;
...
public class SVGBase {
    ...
    public Picture renderToPicture(RenderOptionsBase renderOptions) {
        ...
        if (renderOptions != null && renderOptions.hasViewPort()) {
            ...
            float w = rootElement.width.floatValue(renderDPI);
            float h = rootElement.height.floatValue(renderDPI);
            return renderToPicture((int) Math.ceil(w), (int) Math.ceil(h), renderOptions);
    ...
    public Picture renderToPicture(int widthInPixels, int heightInPixels, RenderOptionsBase renderOptions) {
        ...
        SVGAndroidRenderer renderer = new SVGAndroidRenderer(canvas, renderDPI, externalFileResolver);
    ...
    public void setDocumentWidth(float pixels) {
        ...
        rootElement.width = new Length(pixels);
    }
    ...
    public void setDocumentWidth(String value) throws SVGParseException {
        ...
        rootElement.width = SVGParserImpl.parseLength(value);
    }
    ...
    public void setDocumentHeight(float pixels) {
        ...
        rootElement.height = new Length(pixels);
    }
    ...
    public void setDocumentHeight(String value) throws SVGParseException {
        ...
        rootElement.height = SVGParserImpl.parseLength(value);
    }
    ...
    public void setDocumentViewBox(float minX, float minY, float width, float height) {
        ...
        rootElement.viewBox = new Box(minX, minY, width, height);
    }
    ...
    public RectF getDocumentViewBox() {
        ...
        return rootElement.viewBox.toRectF();
    }
    ...
    public PreserveAspectRatio getDocumentPreserveAspectRatio() {
        ...
        return rootElement.preserveAspectRatio;
    }
    ...
    public float getDocumentAspectRatio() {
        ...
        Length w = rootElement.width;
        Length h = rootElement.height;
        ...
        if (rootElement.viewBox != null && rootElement.viewBox.width != 0f && rootElement.viewBox.height != 0f) {
            return rootElement.viewBox.width / rootElement.viewBox.height;
        }
    ...
    private Box getDocumentDimensions(float dpi) {
        ...
        if (h != null) {
            ...
            if (rootElement.viewBox != null) {
                hOut = (wOut * rootElement.viewBox.height) / rootElement.viewBox.width;
            } else {
                hOut = wOut;
            }
        }
    ...
    static abstract class SvgElementBase extends SvgObject {
        ...
        Style baseStyle;   // style defined by explicit style attributes in the element (eg. fill="black")
        Style style;       // style expressed in a 'style' attribute (eg. style="fill:black")
        List<String> classNames;  // contents of the 'class' attribute
