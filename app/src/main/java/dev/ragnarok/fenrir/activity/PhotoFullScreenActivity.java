...
public class PhotoFullScreenActivity extends NoMainActivity implements PlaceProvider, AppStyleable {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Slidr.attach(this, new SlidrConfig.Builder().fromUnColoredToColoredStatusBar(true).sensitivity(0.7f).position(SlidrPosition.VERTICAL).scrimColor(CurrentTheme.getColorBackground(this)).build());
