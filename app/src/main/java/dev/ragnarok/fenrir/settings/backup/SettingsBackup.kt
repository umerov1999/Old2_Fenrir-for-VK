...
class SettingsBackup {
    private val settings: Array<SettingCollector> = arrayOf(
        ...
        SettingCollector("blur_for_player", SettingTypes.TYPE_BOOL),
        ...
        SettingCollector("native_parcel_enable", SettingTypes.TYPE_BOOL),
        ...
        SettingCollector("player_background_json", SettingTypes.TYPE_STRING),
        SettingCollector("use_hls_downloader", SettingTypes.TYPE_BOOL),
