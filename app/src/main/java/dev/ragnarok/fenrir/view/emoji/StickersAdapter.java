...
//    }
    ...
    public void onViewRecycled(@NonNull RecyclerView.ViewHolder holder) {
        ...
        if (holder instanceof StickerAnimatedHolder) {
            StickerAnimatedHolder animatedHolder = (StickerAnimatedHolder) holder;
            animatedHolder.animation.stopAnimation();
            if (animatedHolder.animation.getDrawable() instanceof RLottieDrawable) {
                ((RLottieDrawable) animatedHolder.animation.getDrawable()).recycle();
            }
        }
    }
