...
public class AiffInfoReader extends AiffChunkReader {
    private static final JLogger LOG = JLoggers.get(AiffInfoReader.class, EalvaTagLog.MARKER);


    protected GenericAudioHeader read(FileChannel fc, String fileName) throws CannotReadException, IOException {
