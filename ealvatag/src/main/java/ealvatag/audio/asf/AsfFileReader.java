...
public class AsfFileReader extends AudioFileReader {
     ...
     */
    @Override
    protected AsfTag getTag(RandomAccessFile raf, boolean ignoreArtwork) throws CannotReadException, IOException {
        raf.seek(0);
        AsfTag tag;
        try {
    ...
    @Override
    public AudioFile read(File f, String extension, boolean ignoreArtwork)
