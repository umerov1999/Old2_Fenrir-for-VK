...
public final class GUID {
     ...
     */
    public final static GUID
            GUID_AUDIO_ERROR_CONCEALEMENT_ABSENT =
            new GUID(new int[]{0x40, 0xA4, 0xF1, 0x49, 0xCE, 0x4E, 0xD0, 0x11, 0xA3, 0xAC, 0x00, 0xA0, 0xC9, 0x03, 0x48, 0xF6},
    ...
    public final static GUID
            GUID_AUDIOSTREAM =
            new GUID(new int[]{0x40, 0x9E, 0x69, 0xF8, 0x4D, 0x5B, 0xCF, 0x11, 0xA8, 0xFD, 0x00, 0x80, 0x5F, 0x5C, 0x44, 0x2B}, " Audio stream");
    ...
    public final static GUID
            ...
            new GUID(new int[]{0xFA, 0xB3, 0x11, 0x22, 0x23, 0xBD, 0xD2, 0x11, 0xB4, 0xB7, 0x00, 0xA0, 0xC9, 0x55, 0xFC, 0x6E},
                    "Content Branding");
    ...
    public final static GUID
            ...
            new GUID(new int[]{0xfb, 0xb3, 0x11, 0x22, 0x23, 0xbd, 0xd2, 0x11, 0xb4, 0xb7, 0x00, 0xa0, 0xc9, 0x55, 0xfc, 0x6e},
    ...
    public final static GUID
            ...
            new GUID(new int[]{0x33, 0x26, 0xB2, 0x75, 0x8E, 0x66, 0xCF, 0x11, 0xA6, 0xD9, 0x00, 0xAA, 0x00, 0x62, 0xCE, 0x6C},
                    "Content Description");
    ...
    public final static GUID
            GUID_ENCODING =
            new GUID(new int[]{0x40, 0x52, 0xD1, 0x86, 0x1D, 0x31, 0xD0, 0x11, 0xA3, 0xA4, 0x00, 0xA0, 0xC9, 0x03, 0x48, 0xF6},
    ...
    public final static GUID
            ...
            new GUID(new int[]{0x40, 0xA4, 0xD0, 0xD2, 0x07, 0xE3, 0xD2, 0x11, 0x97, 0xF0, 0x00, 0xA0, 0xC9, 0x5E, 0xA8, 0x50},
                    "Extended Content Description");

    /**
     * GUID of ASF file header.
     */
    public final static GUID GUID_FILE = new GUID(new int[]{
            0xA1, 0xDC, 0xAB, 0x8C, 0x47, 0xA9, 0xCF, 0x11, 0x8E, 0xE4, 0x00, 0xC0, 0x0C,
            0x20, 0x53, 0x65
    }, "File header");
    ...
    public final static GUID
            GUID_HEADER =
            new GUID(new int[]{0x30, 0x26, 0xb2, 0x75, 0x8e, 0x66, 0xcf, 0x11, 0xa6, 0xd9, 0x00, 0xaa, 0x00, 0x62, 0xce, 0x6c}, "Asf header");

    /**
     * This constant stores a GUID whose functionality is unknown.
     */
    public final static GUID GUID_HEADER_EXTENSION = new GUID(new int[]{
            0xB5, 0x03, 0xBF, 0x5F, 0x2E, 0xA9, 0xCF, 0x11, 0x8E, 0xE3, 0x00,
     ...
     */
    public final static GUID GUID_LANGUAGE_LIST = new GUID(new int[]{
            0xa9, 0x46, 0x43, 0x7c, 0xe0, 0xef, 0xfc, 0x4b, 0xb2, 0x29, 0x39,
            0x3e, 0xde, 0x41, 0x5c, 0x85
    }, "Language List");
    ...
    public final static GUID
            GUID_METADATA =
            new GUID(new int[]{0xea, 0xcb, 0xf8, 0xc5, 0xaf, 0x5b, 0x77, 0x48, 0x84, 0x67, 0xaa, 0x8c, 0x44, 0xfa, 0x4c, 0xca}, "Metadata");

    /**
     * This constant stores the GUID indicating the asf metadata library object.<br>
     */
    public final static GUID GUID_METADATA_LIBRARY = new GUID(new int[]{
            0x94, 0x1c, 0x23, 0x44, 0x98, 0x94, 0xd1, 0x49, 0xa1, 0x41, 0x1d,
            0x13, 0x4e, 0x45, 0x70, 0x54
    }, "Metadata Library");
    /**
     * This constant stores the GUID indicating a stream object.
     */
    public final static GUID GUID_STREAM = new GUID(new int[]{
     ...
     * chunk.
     */
    public final static GUID GUID_STREAM_BITRATE_PROPERTIES = new GUID(new int[]{
            0xCE, 0x75, 0xF8, 0x7B, 0x8D, 0x46, 0xD1, 0x11, 0x8D,
    ...
    public final static GUID
            GUID_UNSPECIFIED =
            new GUID(new int[]{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, "Unspecified");
    /**
     * This constant stores the GUID indicating that stream type is video.
     */
    public final static GUID
            GUID_VIDEOSTREAM =
            new GUID(new int[]{0xC0, 0xEF, 0x19, 0xBC, 0x4D, 0x5B, 0xCF, 0x11, 0xA8, 0xFD, 0x00, 0x80, 0x5F, 0x5C, 0x44, 0x2B}, "Video stream");
    /**
    ...
    public final static GUID
            ...
            new GUID(new int[]{0x30, 0x1a, 0xfb, 0x1e, 0x62, 0x0b, 0xd0, 0x11, 0xa3, 0x9b, 0x00, 0xa0, 0xc9, 0x03, 0x48, 0xf6},
                    "Script Command Object");
    /**
     * The GUID String values format.<br>
     */
    private final static Pattern GUID_PATTERN = Pattern.compile("[a-f0-9]{8}\\-[a-f0-9]{4}\\-[a-f0-9]{4}\\-[a-f0-9]{4}\\-[a-f0-9]{12}",
    ...
    static {
        ...
        GUID_TO_CONFIGURED = new HashMap<>(KNOWN_GUIDS.length);
        for (GUID curr : KNOWN_GUIDS) {
            assert !GUID_TO_CONFIGURED.containsKey(curr) : "Double definition: \"" + GUID_TO_CONFIGURED.get(curr).getDescription() + "\" " +
                    "<-> \"" + curr.getDescription() + "\"";
    ...
    public static boolean assertGUID(int[] value) {
        return value != null && value.length == GUID_LENGTH;
    }
    ...
    public static GUID parseGUID(String guid) throws GUIDFormatException {
        ...
        int[] bytes = new int[GUID_LENGTH];
        /*
         * Don't laugh, but did not really come up with a nicer solution today
         */
        int[] arrayIndices = {3, 2, 1, 0, 5, 4, 7, 6, 8, 9, 10, 11, 12, 13, 14, 15};
        int arrayPointer = 0;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GUID) {
            GUID other = (GUID) obj;
            result = Arrays.equals(getGUID(), other.getGUID());
        }
        return result;
    }
    ...
    public byte[] getBytes() {
        byte[] result = new byte[guidData.length];
        for (int i = 0; i < result.length; i++) {
            result[i] = (byte) (guidData[i] & 0xFF);
        }
        return result;
    }
     ...
     */
    public int[] getGUID() {
        int[] copy = new int[guidData.length];
        System.arraycopy(guidData, 0, copy, 0, guidData.length);
        return copy;
    }
