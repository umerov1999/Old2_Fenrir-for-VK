 ...
 * {@link ealvatag.audio.asf.data.AsfHeader} object if successful. <br>
...
public class AsfHeaderReader extends ChunkContainerReader<AsfHeader> {
    ...
    public static AsfHeader readHeader(File file) throws IOException {
        ...
        AsfHeader result = FULL_READER.read(Utils.readGUID(stream), stream, 0);
        stream.close();
        return result;
    }
