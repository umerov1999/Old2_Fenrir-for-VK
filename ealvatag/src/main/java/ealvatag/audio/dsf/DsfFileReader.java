...
public class DsfFileReader extends AudioFileReader2 {
    ...
    @Override
    protected GenericAudioHeader getEncodingInfo(FileChannel fc, String fileName) throws CannotReadException, IOException {
    ...
    @Override
    protected TagFieldContainer getTag(FileChannel fc, String fileName, boolean ignoreArtwork)
     ...
     */
    private TagFieldContainer readTag(FileChannel fc, DsdChunk dsd, String fileName, boolean ignoreArtwork)
            throws CannotReadException, IOException {
