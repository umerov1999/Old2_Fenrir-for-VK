...
public enum Mp4AtomIdentifier {
    ...
    static {
        ...
        Mp4AtomIdentifier[] values = values();
        for (int i = 0; i < values.length; i++) {
            Mp4AtomIdentifier value = values[i];
    ...
    public static Mp4AtomIdentifier fromHeaderId(String fieldName) {
        Mp4AtomIdentifier mp4AtomIdentifier = idStringToAtomIdentifier.get(fieldName);
     ...
     */
    public boolean matches(String boxType) {
