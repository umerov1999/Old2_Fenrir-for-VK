...
public class Mp4MetaBox extends AbstractMp4Box {
    ...
    public Mp4MetaBox(Mp4BoxHeader metaBoxHeader,
                      BufferedSource bufferedSource,
                      Mp4Tag mp4Tag,
                      boolean ignoreArtwork)
    ...
    public static Mp4MetaBox createiTunesStyleMetaBox(int childrenSize) {
        ...
        metaHeader.setLength(Mp4BoxHeader.HEADER_LENGTH + FLAGS_LENGTH + childrenSize);
        ByteBuffer metaData = ByteBuffer.allocate(FLAGS_LENGTH);
