...
//    public static final int DURATION_LONG_LENGTH = 8;
    ...
    public Mp4MvhdBox(Mp4BoxHeader mvhdBoxHeader, BufferedSource dataBuffer, Mp4AudioHeader audioHeader) throws IOException {
        Preconditions.checkArgument(Mp4AtomIdentifier.MVHD.matches(mvhdBoxHeader.getId()));
        header = mvhdBoxHeader;
    ...
    public long getLength() {
        return (int) (timeLength / timeScale);
    }
