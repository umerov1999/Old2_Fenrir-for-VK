...
public enum AsfFieldKey {
    ...
    static {
        ...
        for (AsfFieldKey curr : values()) {
            if (curr != CUSTOM) {
                Preconditions.checkState(!FIELD_ID_MAP.containsKey(curr.getFieldName()));
     ...
     *                     values.
     */
    AsfFieldKey(String asfFieldName, boolean multiValue) {
     ...
     *                     this.
     */
    AsfFieldKey(String asfFieldName, boolean multiValue, ContainerType lowest, ContainerType highest) {
        fieldName = asfFieldName;
        Preconditions.checkArgument(!multiValue || highest.isMultiValued());
     ...
     */
    public static boolean isMultiValued(String fieldName) {
        AsfFieldKey fieldKey = getAsfFieldKey(fieldName);
