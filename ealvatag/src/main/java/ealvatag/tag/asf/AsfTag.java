...
public final class AsfTag extends AbstractTag {
     ...
     */
    public AsfTag(TagFieldContainer source, boolean copy) throws UnsupportedEncodingException {
        this(copy);
        copyFrom(source);
    }
     ...
     * @param source source to read tag fields from.
     */
    private void copyFrom(TagFieldContainer source) {
    ...
    public String getFirst(AsfFieldKey asfKey) throws IllegalArgumentException {
        ...
        return getFirst(asfKey.getFieldName());
    }
    ...
    public Tag deleteField(FieldKey genericKey) throws IllegalArgumentException, UnsupportedFieldException {
        deleteField(getAsfFieldKey(checkArgNotNull(genericKey, CANNOT_BE_NULL, "genericKey")).getFieldName());
        return this;
    }
    ...
    public Optional<TagField> getFirstField(FieldKey genericKey)
            throws IllegalArgumentException, UnsupportedFieldException {
        return getFirstField(getAsfFieldKey(genericKey).getFieldName());
    }
    ...
    @Override
    public AsfTagTextField createField(FieldKey fieldKey, String... values) throws IllegalArgumentException,
    ...
    private static class AsfFieldIterator implements Iterator<AsfTagField> {
         ...
         */
        AsfFieldIterator(Iterator<TagField> iterator) {
        ...
        public AsfTagField next() {
            return (AsfTagField) fieldIterator.next();
        }
