 ...
 *
 *
 * <p>Simple meta items use the parent atom id as their identifier whereas reverse dns (----) atoms use
 * the reverse dns,issuer and name fields as their identifier. When the atom is non-0standard but follows the rules
...
public enum Mp4FieldKey {
    ...
    RATING("rtng", Mp4TagFieldSubType.BYTE, INTEGER, 1),
    ...
    Mp4FieldKey(String issuer, String identifier, Mp4FieldType fieldType) {
        ...
        fieldName = BuilderHolder.makeFieldName(issuer, identifier);
        subclassType = Mp4TagFieldSubType.REVERSE_DNS;
        this.fieldType = fieldType;
    }
    ...
    public boolean fieldMatchesId(String id) {
    ...
    private static class BuilderHolder {
        ...
        private static String makeFieldName(@NotNull String issuer, @NotNull String identifier) {
            //Mp4TagReverseDnsField.IDENTIFIER + ":" + issuer + ":" + identifier;
            builder.setLength(0);
            builder.append(Mp4TagReverseDnsField.IDENTIFIER)
                    .append(':')
                    .append(issuer)
                    .append(':')
                    .append(identifier);
