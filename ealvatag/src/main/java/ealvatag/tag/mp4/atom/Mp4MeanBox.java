...
public class Mp4MeanBox extends AbstractMp4Box {
    ...
    public Mp4MeanBox(Mp4BoxHeader header, ByteBuffer dataBuffer) {
        ...
        //issuer
        issuer = Utils.getString(this.dataBuffer, PRE_DATA_LENGTH, header.getDataLength() - PRE_DATA_LENGTH, header.getEncoding());

    }

    public Mp4MeanBox(Mp4BoxHeader meanBoxHeader, Buffer buffer) throws EOFException {
