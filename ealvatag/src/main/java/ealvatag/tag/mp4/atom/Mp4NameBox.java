...
public class Mp4NameBox extends AbstractMp4Box {
    ...
    public Mp4NameBox(Mp4BoxHeader header, ByteBuffer dataBuffer) {
        ...
        //issuer
        name = Utils.getString(this.dataBuffer, PRE_DATA_LENGTH, header.getDataLength() - PRE_DATA_LENGTH, header.getEncoding());
    }

    public Mp4NameBox(Mp4BoxHeader nameBoxHeader, Buffer buffer) throws EOFException {
