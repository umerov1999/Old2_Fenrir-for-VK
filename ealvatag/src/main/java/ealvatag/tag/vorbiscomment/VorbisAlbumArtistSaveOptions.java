...
public enum VorbisAlbumArtistSaveOptions {
    WRITE_ALBUMARTIST {
        @Override
        public void setField(ContainsVorbisCommentField tag, FieldKey genericKey, String value)
        ...
        @Override
        public void addField(ContainsVorbisCommentField tag, FieldKey genericKey, String value)
                throws IllegalArgumentException, FieldDataInvalidException {
            TagField tagfield = tag.createField(genericKey, value);
        ...
        @Override
        public void deleteField(VorbisCommentTag tag,
                                VorbisCommentFieldKey mappedKey)
