...
public abstract class PreferenceFragmentCompat extends Fragment implements
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        boolean allowDividerAfterLastItem = a.getBoolean(
        ...
        View view = themedInflater.inflate(mLayoutResId, container, false);
        ...
        RecyclerView listView = onCreateRecyclerView(themedInflater, listContainer,
                savedInstanceState);
        if (listView == null) {
    ...
    public void setPreferencesFromResource(@XmlRes int preferencesResId, @Nullable String key) {
        ...
        PreferenceScreen xmlRoot = mPreferenceManager.inflateFromResource(getContext(),
    ...
    @SuppressWarnings("TypeParameterUnusedInFormals")
    @Nullable
    public <T extends Preference> T findPreferenceByName(@Nullable String str) {
        if (mPreferenceManager == null || TextUtils.isEmpty(str)) {
            return null;
        }
        assert str != null;
        return mPreferenceManager.findPreferenceByName(str);
    }
    ...
    private class DividerDecoration extends RecyclerView.ItemDecoration {
        ...
        private boolean shouldDrawDividerBelow(View view, RecyclerView parent) {
            ...
            boolean dividerAllowedBelow = holder instanceof PreferenceViewHolder
