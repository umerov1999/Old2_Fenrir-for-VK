...
public class PreferenceGroupAdapter extends RecyclerView.Adapter<PreferenceViewHolder>
    ...
    private void flattenPreferenceGroup(List<Preference> preferences, PreferenceGroup group) {
        ...
        for (int i = 0; i < groupSize; i++) {
            ...
            PreferenceResourceDescriptor descriptor = new PreferenceResourceDescriptor(
                    preference);
    ...
    private ExpandButton createExpandButton(final PreferenceGroup group,
        ...
        ExpandButton preference = new ExpandButton(
                group.getContext(),
    ...
    public void onPreferenceChange(Preference preference) {
        int index = mVisiblePreferences.indexOf(preference);
    ...
    public PreferenceViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        PreferenceResourceDescriptor descriptor = mPreferenceResourceDescriptors.get(
                viewType);
