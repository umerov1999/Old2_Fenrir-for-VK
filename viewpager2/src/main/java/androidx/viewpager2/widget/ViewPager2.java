...
public final class ViewPager2 extends ViewGroup {
    ...
    private RestorePositionListener restorePositionListener;
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        if (restorePositionListener == null) {
            mPendingCurrentItem = ss.mCurrentItem;
        } else {
            mPendingCurrentItem = restorePositionListener.doRestorePosition();
        }
    ...
    public void setRestorePositionListener(@Nullable RestorePositionListener restorePositionListener) {
        this.restorePositionListener = restorePositionListener;
    }
